<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:83:"D:\phpstudy\PHPTutorial\WWW\mdd/application/admin\view\agent\agent_manage\index.php";i:1565592080;s:75:"D:\phpstudy\PHPTutorial\WWW\mdd\application\admin\view\public\container.php";i:1565592080;s:76:"D:\phpstudy\PHPTutorial\WWW\mdd\application\admin\view\public\frame_head.php";i:1565592080;s:71:"D:\phpstudy\PHPTutorial\WWW\mdd\application\admin\view\public\style.php";i:1565592080;s:76:"D:\phpstudy\PHPTutorial\WWW\mdd\application\admin\view\public\inner_page.php";i:1565592080;s:78:"D:\phpstudy\PHPTutorial\WWW\mdd\application\admin\view\public\frame_footer.php";i:1565592080;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                        ...
                        <tbody>
                         <?php $count = count($list); if($count): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    ...
                                    <td class="text-center">
                                        <?php if($vo['user_type'] == 'routine'): ?>
                                           暂无
                                        <?php else: if(isset($vo['qr_code']['url'])): ?>
