<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\phpstudy\PHPTutorial\WWW\mdd/application/admin\view\widget\images.php";i:1565592080;}*/ ?>
<!DOCTYPE html>
...
<script>
    ...
    var uploadurl = "<?php echo Url('upload',array('pid'=>\think\Request::instance()->param('pid'))); ?>"; //上传图片地址
